...
st.set_page_config(page_title="App 4", page_icon="🧮", layout="wide")

st.title("🧮 App 4")
st.caption("Substitui este ficheiro pelo código da tua 4ª aplicação.")
...
st.markdown(
    ...
    **Como converter a tua app original para aqui:**
    ...
    3. Renomeia o ficheiro para algo como `4_📈_Nome_Da_App.py` — o número controla
