...
<style>
    ...
    .hero-header {
        background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); border-radius: 16px; padding: 28px;
    ...
    .custom-table tr.category-row th { background-color: #1e293b; color: #ffffff; text-align: left; font-size: 12px; text-transform: uppercase; letter-spacing: 0.05em; padding: 8px 14px; }
...
# 6. INTERFACE
# ------------------------------------------------------------------------------
st.title("🏢 Análise Comprehensiva de REITs")
st.caption("Relatório executivo de REITs: FFO/AFFO, valuation, dividendos, alavancagem, risco de mercado e comparação com concorrentes.")
